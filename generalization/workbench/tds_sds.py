...
PURE_ALIAS = {'MEK': 'TT444', '外加正丁醇': '正丁醇', 'TM982b': 'TM982',
              '100#溶剂油': '100号溶剂油'}   # 100# = 100号（S-100 轻芳烃溶剂石脑油，TDS/SDS 已登记）
...
FAMILY = {
    ...
    '25%5100': dict(role='树脂', rtype='环氧', nv=25.0, copy_from='IR877',
                   依据='代码名自证：HY-5100（安徽恒远 双酚A型环氧，族档案 IR877 口径）'
                        '25% 稀释品；同族推断档，非直接实测'),
...
CODE_MAP = {
    ...
    '35.7%白浆-新(无306)': dict(pid='TIO2-PASTE', nv=35.7, role='颜料', pig_pct=35.7,
                               依据='同「35.7%白浆」（钛白粉浆料，固含 35.7% 自证）；'
                                    '后缀「-新(无306)」仅指浆料配方不含 306 助剂的变体，'
                                    '档案口径与母浆一致'),
    ...
    '100号溶剂油': dict(pid='SOLVENT-N100', nv=0.0,
                       依据='100号溶剂油（轻芳烃溶剂石脑油 S-100，CAS 64742-95-6）：'
                            'TDS 密度 0.865-0.880、SDS 闪点 45min/沸点范围≤260℃；'
                            '数据集代码「100#溶剂油」即同一物料'),
