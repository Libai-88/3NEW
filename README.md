...
| 第二阶段 · 跨体系泛化方案（终极版） | [`generalization/`](generalization/README.md) | 跨体系通用描述符、终极版数据集模板、合并版数据集、配套 Windows 工作台、最终验证（R²>0.7 / acc>0.8） |

> 第二阶段面向更多涂料体系，交付终极版泛化方案 + 终极版模板 + 自动化工作台 + 合并版数据集，详见 [`generalization/README.md`](generalization/README.md)。
