...
| 第二阶段 · 跨体系数据集（终极版模板 + 合并版数据集） | [`generalization/`](generalization/README.md) | 跨体系通用描述符（TDS/SDS 实测层，69/73 原料锚定）、终极版数据集模板、合并版数据集、配套 Windows 工作台、最终验证（T弯掩码 R²≈0.75 / MEK 未截尾 R²≈0.46 / 水煮 acc≈0.76，诚实协议） |
